  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
        ...
        <div className='text-center my-8'>
          ...
          <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Itaque aut similique recusandae facere non, nobis autem?</p>
...
<button type='submit' onClick={onSubmitHandler} className='border-l border-black py-4 sm:px-8 active:bg-gray-600 active:text-white'>Subscribe</button>
